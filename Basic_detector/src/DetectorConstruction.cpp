...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  G4Material* scintillator = nistManager->FindOrBuildMaterial( "G4_Pyrex_Glass" );
  G4Material* PbWO4 = nistManager->FindOrBuildMaterial("G4_PbWO4");  // Lead tungstate crystal (excellent EM calorimeter)
  ...
  G4double tracker2InnerRadius = 799.5*cm;
